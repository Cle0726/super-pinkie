...
class ContextBudgetTests(unittest.TestCase):
    ...
    def test_provider_limits_are_not_guessed_from_names(self):
        ...
        self.assertEqual(11200,a['threshold']);self.assertEqual(89600,b['threshold'])
        unknown=budget['model_budget']('other/same',cfg,self.home)
        self.assertEqual('conservative-fallback',unknown['source']);self.assertEqual(32768,unknown['window'])
    def test_codex_metadata_and_explicit_override(self):
        ...
        self.assertEqual(133000,budget['model_budget']('codex-cli/model-a',{},self.home)['threshold'])
        ...
        self.assertEqual(44800,budget['model_budget']('codex-cli/model-a',{},self.home)['threshold'])
    def test_setup_preserves_personas_auth_and_explicit_values_and_is_idempotent(self):
        ...
        self.assertEqual(64000,provider['models'][0]['contextWindow']);self.assertEqual(32768,provider['models'][1]['contextWindow'])
    ...
    def test_agent_cap_does_not_overwrite_provider_capacity_and_override_is_effective(self):
        ...
        self.assertEqual(11200,budget['model_budget']('a/known',saved,self.home)['threshold'])
        ...
        self.assertEqual(8400,budget['model_budget']('a/known',saved,self.home)['threshold'])
    ...
    def test_failed_summary_does_not_modify_old_checkpoint(self):
        limits=budget['model_budget']('x/y',{},self.home);old={'summary':'已有摘要','through_id':4}
